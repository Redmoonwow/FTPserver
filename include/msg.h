...
#define FTP_MSG_REQ_END_THREAD_CMD			FTP_MSG_BASE_CHILD_THREAD	| 0x0208 // スレッド終了要求(FILEIF)
#define FTP_MSG_RES_END_THREAD_CMD			FTP_MSG_BASE_CHILD_THREAD	| 0x0209 // スレッド終了応答(FILEIF)
