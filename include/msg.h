...
//#### マネージャー間メッセージ
#define FTP_MSG_BASE_MANAGER				0xA0000000
#define FTP_MSG_REQ_TRANS					FTP_MSG_BASE_MANAGER		| 0x0000 // 転送要求		
#define FTP_MSG_RES_TRANS					FTP_MSG_BASE_MANAGER		| 0x0001 // 転送応答
...
#define FTP_MSG_REQ_END_ALL_SESSION_CHILD	FTP_MSG_BASE_MANTENANCE		| 0x0007 // 子プロセス全セッション終了要求
#define FTP_MSG_RES_END_ALL_SESSION_CHILD	FTP_MSG_BASE_MANTENANCE		| 0x0008 // 子プロセス全セッション終了応答
...
// TRANS <==> TRANS MANAGER
#define FTP_MSG_REQ_TRANSFER_TRANS_CHILD	FTP_MSG_BASE_CHILD_THREAD	| 0x0200 // 子プロセス転送要求TRANS
#define FTP_MSG_RES_TRANSFER_TRANS_CHILD	FTP_MSG_BASE_CHILD_THREAD	| 0x0201 // 子プロセス転送応答TRANS
...
// 転送要求
typedef struct st_msg_req_trans
{
	st_mq_header	m_mq_header;
	int32_t			m_sessionid;
	int32_t			m_command;
...
// 転送応答
typedef struct st_msg_res_trans
{
	st_mq_header	m_mq_header;
	int32_t			m_sessionid;
	int32_t			m_command;
